...
public class DriveEncoderLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = -0.007;
    public static double STRAFE_TICKS_TO_INCHES = 1.1643;
    public static double TURN_TICKS_TO_RADIANS = 3.0892;
    public static double ROBOT_WIDTH = 14;
    public static double ROBOT_LENGTH = 15.5;
